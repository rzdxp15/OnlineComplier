 ...
 *
 * 然后在把�?有报错的地方修改�?下，主要修改�?
 * 1. 构�?�函数的类名：Scanner -> HackScanner
...
public final class HackScanner implements Iterator<String>, Closeable {
    ...
    public HackScanner(InputStream source) {
        // 判断�?下输入的 InputStream 是不�? HackInputStream�?
        // 如果是就调用�?下它�? get 方法，把当前线程的输入流�? ThreadLocal 中取出来传入
     ...
     * @return this scanner
     */
    public com.execute.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public com.execute.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public com.execute.HackScanner useLocale(Locale locale) {
     ...
     */
    public com.execute.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.execute.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.execute.HackScanner skip(String pattern) {
     ...
     * @since 1.6
     */
    public com.execute.HackScanner reset() {
