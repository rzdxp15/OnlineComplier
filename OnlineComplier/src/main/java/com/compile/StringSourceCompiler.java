...
public class StringSourceCompiler {
    ...
    public static class TmpJavaFileObject extends SimpleJavaFileObject {
        ...
        /**
         * 构�?�用来存储源代码的JavaFileObject
         * �?要传入源码source，然后调用父类的构�?�方法创建kind = Kind.SOURCE的JavaFileObject对象
         */
        ...
        /**
         * 构�?�用来存储字节码的JavaFileObject
         * �?要传入kind，即我们想要构建�?个存储什么类型文件的JavaFileObject
         */
